...
/***/ function(module, exports, __webpack_require__) {
	...
	// Waypoints is best when using scroll events.
	...
	var RevealOnScroll = function () {
		...
		_createClass(RevealOnScroll, [{
			...
			value: function createWaypoints() {
				// Method using Waypoints for each element in our collection. 
				var that = this; // 
				this.itemsToReveal.each(function () {
					...
					new Waypoint({ // Uses the waypoints class we imported at the top. Each waypoint object needs at least 2 properties.
						...
						handler: function handler() {
							(0, _jquery2.default)(currentItem).addClass("reveal-item--is-visible"); // Targeting current DOM element and adding class to it.
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StickyHeader = function () {
		function StickyHeader() {
			...
			this.pageSections = (0, _jquery2.default)(".page-section"); // collection of all our page section elements
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Modal = function () {
		function Modal() {
			...
			this.openModalButton = (0, _jquery2.default)(".open-modal"); // Selecting DOM elements we need to work with
